...
<div class="section-header">
    ...
    <div class="options">
        <asp:Button ID="btnSave" runat="server" CssClass="adminButtonBlue" Text="<% $NopResources:Admin.BlacklistNetworkAdd.SaveButton.Text %>"
            OnClick="OnSaveClick" ToolTip="<% $NopResources:Admin.BlacklistNetworkAdd.SaveButton.Tooltip %>" />
    </div>
</div>
<p>
</p>
