...
<div class="section-header">
    ...
    <div class="options">
        <asp:Button ID="btnSave" runat="server" CssClass="adminButtonBlue" Text="<% $NopResources:Admin.BlacklistIPAdd.SaveButton.Text %>"
            OnClick="OnSaveClick" ToolTip="<% $NopResources:Admin.BlacklistIPAdd.SaveButton.Tooltip %>" />
    </div>
</div>
<p>
</p>
