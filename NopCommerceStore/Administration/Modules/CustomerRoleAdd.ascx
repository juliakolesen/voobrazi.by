...
<div class="section-header">
    <div class="title">
        <img src="Common/ico-customers.png" alt="<%=GetLocaleResourceString("Admin.CustomerRoleAdd.BackToCustomerRoles")%>" />
        <%=GetLocaleResourceString("Admin.CustomerRoleAdd.BackToCustomerRoles")%>
