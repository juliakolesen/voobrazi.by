<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.Administration.Modules.PaymentMethodsControl"
    CodeBehind="PaymentMethods.ascx.cs" %>
...
<asp:GridView ID="gvPaymentMethods" runat="server" AutoGenerateColumns="False" Width="100%">
    <Columns>
        <asp:BoundField DataField="PaymentMethodID" HeaderText="PaymentMethod ID" Visible="False">
        </asp:BoundField>
