...
<table class="adminContent">
    <tr>
        <td width="100%">
            <asp:UpdatePanel ID="upProductCategoryMappings" runat="server">
                <ContentTemplate>
            ...
            <asp:UpdateProgress ID="updateProgressCategoryProductMappings" runat="server" AssociatedUpdatePanelID="upProductCategoryMappings">
                <ProgressTemplate>
                    <div class="progress">
