...
<ajaxToolkit:TabContainer runat="server" ID="tabBlacklist" ActiveTabIndex="0">
    <ajaxToolkit:TabPanel runat="server" ID="pagIpAddress" HeaderText="<% $NopResources:Admin.Blacklist.IpAddress.Title %>">
        <ContentTemplate>
    ...
    <ajaxToolkit:TabPanel runat="server" ID="pagIpNetwork" HeaderText="<% $NopResources:Admin.Blacklist.IpNetwork.Title %>">
        <ContentTemplate>
