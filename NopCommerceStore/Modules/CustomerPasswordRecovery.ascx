            ...
            <tr>
                ...
                <td style="text-align: left; vertical-align: middle;">
                    <asp:Button runat="server" ID="btnPasswordRecovery" Text="<% $NopResources:Account.PasswordRecovery.RecoverButton %>"
                        ValidationGroup="PasswordRecovery" OnClick="btnPasswordRecovery_Click" SkinID="PasswordRecoveryButton">
                    </asp:Button>
                </td>
            </tr>
        </table>
            ...
            <tr>
                ...
                <td style="text-align: left; vertical-align: middle;">
                    <asp:Button runat="server" ID="btnNewPassword" Text="<% $NopResources:Account.PasswordRecovery.NewPasswordSubmit %>"
                        ValidationGroup="NewPassword" OnClick="btnNewPassword_Click" SkinID="NewPasswordButton">
                    </asp:Button>
                </td>
            </tr>
        </table>
