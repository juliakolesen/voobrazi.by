    ...
    <div class="prices-wrapper">
        ...
        <div class="buttons">
            <asp:Button runat="server" ID="btnProductDetails" OnCommand="btnProductDetails_Click"
                ...
                CommandArgument='<%# Eval("ProductID") %>' SkinID="ProductListProductDetailButton" />
            <br />
            <asp:Button runat="server" ID="btnAddToCart" OnCommand="btnAddToCart_Click" Text="<% $NopResources:Products.AddToCart %>"
                ValidationGroup="ProductDetails" CommandArgument='<%# Eval("ProductID") %>' SkinID="ProductListAddToCartButton" />
        </div>
    </div>
</div>
