    ...
    public partial class ProductBox1Control : BaseNopUserControl
    {
        ...
        private void BindData()
        {
            if (product != null)
            {
                ...
                divProductInfoLink.Attributes.Add("onclick", "document.location.href=document.getElementById('" + hlImageLink.ClientID + "').href;");
        ...
        private void SetNoAtStock()
        {
            divProductInfoLink.InnerHtml = "нет на складе";
            //divProductInfoLink.Attributes["onclick"] = "";
            divProductInfoLink.Style.Add("padding-top", "14px");
            //divProductInfoLink.Style["cursor"] = "default";
            //hlImageLink.NavigateUrl = "javascript:void(0);";
            //hlImageLink.Style.Add("cursor", "default");
        }
