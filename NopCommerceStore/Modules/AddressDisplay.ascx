        ...
        <tr>
            ...
            <td align="right" style="padding: 5px 5px 5px 0px;">
                ...
                <asp:Button runat="server" ID="btnEditAddress" OnCommand="btnEditAddress_Click" Text="<% $NopResources:Address.Edit %>"
                    ValidationGroup="EditAddress" SkinID="EditAddressButton" />
                <%} %>
                <%if (ShowDeleteButton)
                  { %>
                <asp:Button runat="server" ID="btnDeleteAddress" OnCommand="btnDeleteAddress_Click"
                    Text="<% $NopResources:Address.Delete %>" CausesValidation="false" SkinID="DeleteAddressButton" />
                <%} %>
            </td>
        </tr>
        <tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <div>
                                    <asp:Literal ID="lCity" Visible="false" runat="server"></asp:Literal>
                                    <asp:Literal ID="lStateProvince" Visible="false" runat="server"></asp:Literal>
                                    <asp:Literal ID="lZipPostalCode" Visible="false" runat="server"></asp:Literal></div>
