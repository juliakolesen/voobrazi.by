...
namespace NopSolutions.NopCommerce.Web.Templates.Categories
{
    public partial class ProductsInGrid : BaseNopUserControl
    {
        protected void BindData()
        {
            ...
            {
                productsPager.PageSize = productsPagerBottom.PageSize = pageSize;
                productsPager.TotalRecords = productsPagerBottom.TotalRecords = totalRecords;
                productsPager.PageIndex = productsPagerBottom.PageIndex = CurrentPageIndex;
